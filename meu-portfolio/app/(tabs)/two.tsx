...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 26, fontWeight: '700', color: '#CCD6F6', padding: 20 },
  ...
  cargo: { fontSize: 18, fontWeight: 'bold', color: '#64FFDA', marginBottom: 4 },
  empresa: { fontSize: 14, color: '#8892B0', fontWeight: '600', marginBottom: 10, textTransform: 'uppercase' },
  descricao: { fontSize: 14, color: '#8892B0', lineHeight: 22 },
});